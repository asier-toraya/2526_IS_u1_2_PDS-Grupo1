...
| Campo       | Valor                          |
|-------------|--------------------------------|
| **Empresa** | [Kiwi Incidentes]         |
| **Versión** | 1.0                            |
| **Fecha**   | [11/11/2025]         |
| **Autores** | [Asier, Adrian, Inca, Nerea]           |
| **Estado**  | Revisión  |
...
[**1.2 Plan Director de Seguridad**](#1.2-plan-director-de-seguridad)

[**2\. Situación Actual de la Empresa**](#2.-situación-actual-de-la-empresa)

[**2.1 Contexto de la empresa y estrategia de negocio**](#2.1-contexto-de-la-empresa-y-estrategia-de-negocio)

[**2.2 Acotar y establecer un alcance**](#2.2-acotar-y-establecer-un-alcance)

[**2.3 Identificación de los responsables de gestión de los activos**](#2.3-identificación-de-los-responsables-de-gestión-de-los-activos)

[**3\. Análisis de riesgo**](#3.-análisis-de-riesgo)

[**3.1. Alcance del análisis**](#3.1.-alcance-del-análisis)

[**3.2. Análisis de los activos**](#3.2.-análisis-de-los-activos)

[**3.3.  Análisis de las amenazas**](#3.3.-análisis-de-las-amenazas)
...
[**5\. Estrategia de la Empresa**](#5.-estrategia-de-la-empresa)

[**6\. Definición de Proyectos e Iniciativas**](#6.-definición-de-proyectos-e-iniciativas)

[**7\. Clasificación y Priorización de los Proyectos**](#7.-clasificación-y-priorización-de-los-proyectos)

[**8\. Aprobación del PDS**](#8.-aprobación-del-pds)

[**8.1. Puesta en Marcha del PDS**](#8.1.-puesta-en-marcha-del-pds)

[**8.2. Tareas Asociadas y Responsables**](#8.2.-tareas-asociadas-y-responsables)
...
Para entender el concepto de seguridad de la información hay que tener presente que no se trata únicamente de la eliminación de amenazas básicas, si no que está también abarca los procedimientos que deben seguir los empleados y altos directivos de una empresa para asegurar la protección de datos sensibles. 
 ...
 La seguridad de la información es importante para asegurar la continuidad de las operaciones de la empresa, por lo que será primordial la protección de los sistemas de información y la información de intrusiones y alteraciones no deseadas. La protección de los datos sensibles de los proveedores,clientes y la empresa, es la base para mantener la reputación y confianza en el mercado cada vez más digitalizados. En un entorno donde las amenazas cibernéticas crecen, tener una gestión adecuada y estratégias de seguridad que minimicen los riesgos que podrían paralizar la actividad y dañar la reputación es esencial. 

## **1.2 Plan Director de Seguridad**

Es un instrumento estratégico que define los principios generales, políticas y actuaciones en materia de seguridad de la información, alineado con la estrategia de negocio y aprobado por la dirección. Su propósito es gestionar de forma planificada los riesgos, priorizar recursos y establecer controles que protejan los activos  a corto, medio y largo plazo, seleccionando a los responsables de su seguimiento e implantación. Sus proyectos estarán orientados a una visión tanto técnica como de contenido legal y organizativo. 

Es importante que el Plan Director de Seguridad (a partir de ahora PDS) se encuentre alineado con los objetivos estratégicos de la empresa y contar con el acuerdo de la dirección, pues es fundamental que todo el personal conozca los riesgos y amenazas de los que es objeto la empresa. 

# **2\. Situación Actual de la Empresa**

## **2.1 Contexto de la empresa y estrategia de negocio**

La empresa asesora a autónomos y pymes, tiene 150 empleados en dos sedes, está estructurada en varios departamentos( facturación, ventas, compras, comunicación y redes sociales, TIC, RRHH, delivery, mantenimiento, legal y consejo de administración). Su estrategia está basada en la transformación digital , centrada en la página web y tienda online que conecta con clientes para la prestación de servicios.

## **2.2 Acotar y establecer un alcance**

El PDS tiene un alcance limitado, se excluyen activos no críticos, que se destinan a garantizar la protección adecuada de los recursos más críticos y cubrir los sistemas, activos y procesos que son fundamentales para respaldar las operaciones digitales y operativas de la compañía. Específicamente, el plan se centra en:

* Los puestos de trabajo y dispositivos móviles que se utilizan en las dos sedes para permitir que los empleados cumplan con sus tareas diarias.  
* Las aplicaciones empresariales, los servidores de correo electrónico y los sistemas de almacenamiento internos que administran datos sensibles y procedimientos críticos.  
* La infraestructura de red, que incluye redes Wi-Fi segmentadas y cortafuegos, los cuales aseguran una conexión segura entre servicios y usuarios.  
* Los servicios en la nube para operar y almacenar datos, cuya integridad y disponibilidad tienen un impacto directo sobre la continuidad del negocio.  
* La tienda y sitio web en línea externalizados, que son el canal principal de prestación de servicios y el contacto primordial con los clientes.

Este alcance se define con el objetivo de centrar las acciones y los recursos de seguridad en aquellos activos que suponen una mayor vulnerabilidad y valor para la compañía, evitando dispersar esfuerzos en áreas que no impactan directamente en la protección de datos sensibles ni en la operación digital.

Además el alcance incluye tanto los elementos organizativos como los aspectos tecnológicos relacionados con los activos mencionados, incluyendo la cooperación con proveedores externos para garantizar que se cumplan los requisitos de seguridad acordados.

## **2.3 Identificación de los responsables de gestión de los activos**

En nuestra empresa, cada departamento tiene un responsable de activos TIC. Además, existe un responsable de seguridad que coordina las subcontratas encargadas de seguridad física y ciberseguridad. La seguridad física externa es gestionada por terceros en ambas sedes.

En pymes es usual encontrar que una única persona es la encargada de asumir varios roles, pero es importante que esto quede siempre documentado, esto reflejará al responsable de la toma de decisiones y valoración de controles.

Los roles principales para la gestión de responsabilidades suelen ser: 

* Responsable de **Seguridad**: encargado de coordinar el plan y realizar el seguimiento de las medidas.  
* Responsable de **información**: se encarga de velar por los datos concretos.  
* Responsables de **ámbito**: supervisarán los controles lógicos, legales, físicos y organizativos. 

| Rol | Responsable | Funciones clave |
| :---- | :---- | :---- |
| Responsable de Seguridad | Dpto. Seguridad / CISO | Supervisión general del PDS |
| Responsable TIC | Admin. sistemas | Gestión técnica y copias |
| Responsable Legal | Consultoría RGPD | Cumplimiento normativo |
...
### **3.4.  Establecimiento de las vulnerabilidades**
...
## **3.5. Vulnerabilidades/Debilidades**
...
## **4\. Objetivos basados en los activos críticos**
...
**4.1. Estrategia de tratamiento del riesgo:**  
...
**4.2. Iniciativas y controles a implantar:**
...
# **6\. Definición de Proyectos e Iniciativas** 
...
La tabla con dichas iniciativas se encuentra en Anexo 4\.

# **7\. Clasificación y Priorización de los Proyectos**  
...
# **8\. Aprobación del PDS** 

El PDS que estamos desarrollando debe ser presentado y aprobado formalmente por la dirección general y el consejo de administración para asegurar el compromiso institucional, asignación de recursos. Este respaldo es fundamental para asegurar la difusión del plan en todos los niveles de organización y para promover una cultura de seguridad compartida.
...
# **8.1. Puesta en Marcha del PDS** 

La estrategia tiene un plazo inicial de dos años, con revisiones cada seis meses para ajustar las medidas a los cambios tecnológicos, la reestructuración del negocio y las nuevas amenazas que surjan.

De esta forma, se asegura que el PDS atienda de manera efectiva y realista las necesidades concretas de la empresa, respaldando su estrategia para transformarse digitalmente y garantizando la continuidad y la confianza de los clientes.

Para la puesta en marcha del PDS, se elaborará un cronograma detallado con los proyectos e iniciativas mencionados anteriormente, además de responsables, recursos necesarios y plazos claros para la ejecución de cada proyecto definido. Este cronograma permitirá organizar el trabajo de manera eficiente, garantizando que las acciones se realicen en tiempo y forma, facilitando así el cumplimiento de los objetivos propuestos.

También se realizará un seguimiento continuo y riguroso de la evolución y eficacia de las medidas implantadas. Se programaran revisiones periódicas para evaluar el progreso, detectar desviaciones de tiempo respecto al cronograma y aplicar los cambios necesarios asegurando que el plan se mantenga actualizado y alineado con las necesidades, recursos y cambios de la empresa.

# **8.2. Tareas Asociadas y Responsables** 
...
El Plan Director de Seguridad aquí presentado establece una hoja de ruta clara y alineada con la estrategia digital de la empresa para gestionar los riesgos y proteger los activos críticos. Se destaca la necesidad de formalizar políticas, mejorar controles tecnológicos y fortalecer la formación de los empleados para minimizar vulnerabilidades.

La implementación progresiva de los proyectos priorizados permitirá mitigar los riesgos más críticos, garantizar la continuidad operativa y mantener la confianza de clientes y proveedores en el entorno digital. La aprobación y compromiso de la dirección son esenciales para el éxito y sostenibilidad del plan a largo plazo.

**Bibliografía**

1. **Instituto Nacional de Ciberseguridad (INCIBE).** (2025). Guía para la elaboración del Plan Director de Seguridad. Recuperado de [https://www.incibe.es](https://www.incibe.es/)

2. **AyudaLeyProtecciónDatos.es. (2020).** Ejemplos de Plan Director de Seguridad. Recuperado de [https://ayudaleyprotecciondatos.es/2020/10/30/plan-director-de-seguridad/](https://ayudaleyprotecciondatos.es/2020/10/30/plan-director-de-seguridad/)

3. Soriano, M. (2014). *Seguridad en redes y seguridad de la información* (Primera edición). České vysoké učení technické v Praze. [https://psm.fei.stuba.sk/pages/47/Seguridad\_de\_Red\_e\_Informacion.pdf](https://psm.fei.stuba.sk/pages/47/Seguridad_de_Red_e_Informacion.pdf)

4. A2Secure. (2023). Plan Director de Seguridad y su importancia en empresas. Recuperado de [https://www.a2secure.com/plan-director-seguridad/](https://www.a2secure.com/plan-director-seguridad/)

5. **Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo**, de 27 de abril de 2016, relativo a la protección de las personas físicas en lo que respecta al tratamiento de datos personales y a la libre circulación de estos datos (RGPD). Diario Oficial de la Unión Europea, L 119/1.

6. **Nimbustech. (2025).** Cómo hacer e implantar un plan director de seguridad. Recuperado de [https://nimbustech.es/consultoria/como-implantar-un-plan-director-de-seguridad/](https://nimbustech.es/consultoria/como-implantar-un-plan-director-de-seguridad/)

7. **Prosegur. (2024).** Cómo hacer la implantación del plan de director de seguridad. Recuperado de [https://www.prosegur.es/blog/seguridad/plan-director-de-seguridad](https://www.prosegur.es/blog/seguridad/plan-director-de-seguridad)

8. **Euroinnova Business School. (2024)**. 6 fases de un plan director de seguridad. Recuperado de [https://www.euroinnova.com/ciberseguridad-y-cloud-computing/articulos/plan-director-de-seguridad](https://www.euroinnova.com/ciberseguridad-y-cloud-computing/articulos/plan-director-de-seguridad)

9. **Iberasync. (2023).** El Plan Director de Seguridad. Recuperado de [https://iberasync.es/el-plan-director-de-seguridad/](https://iberasync.es/el-plan-director-de-seguridad/)
...
### **1\. Calendario de realización y seguimiento** 
...
| ID | Proyecto | Objetivo | Alcance | Responsable | Recursos | Duración | Coste | Dependencias |
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| 01 | Políticas de seguridad de la información | Definir el marco normativo y los compromisos de la dirección | A toda la empresa | Responsable de Seguridad | Consultoría externa | 2 meses | 3.000€ | Aprobación de la dirección |
| 02 | Copias de seguridad | Garantizar la integridad y disponibilidad de la información  | Sistemas críticos | Responsable de IT | Software  de backup | 1 mes | 2.000€ | Inventario de activos |
| 03 | Control y seguimiento de proveedores externo | Asegurar el cumplimiento de requisitos de seguridad | Proveedores externos | Responsable de ámbito | Herramientas de gestión | 2 meses | 1.500€ | Contratos actualizados |
| 04 | Formación y concienciación de empleados | Sensibilizar y capacitar al personal en buenas prácticas | Todo el personal  | Responsable de Seguridad | Plataforma e-learning | 3 meses | 2.000€ | Disponibilidad de empleados |
| 05 | Implementación del principio de privilegio mínimo | Limitar el acceso de usuarios exclusivamente a los recursos necesarios | Sistemas y usuarios | Responsable de ámbito | Herramientas de gestión de accesos | 2 meses | 1.200€ | Inventario de roles y accesos |
| 06 | Segmentación de redes y cifrado de datos | Proteger la información mediante la separación de redes y cifrado de datos | Datos sensibles y redes | Responsable de Seguridad | Firewall, software de cifrado | 2 meses | 2.500€ | Inventario de activos críticos |
| 07 | Plan de respuesta y recuperación | Establecer procedimientos ante incidentes y su recuperación | Toda la empresa | Responsable de Seguridad | Equipo técnico, consultoría externa | 2 meses | 2.000€ | Copias de seguridad implementadas |
| 08 | Seguridad web y pentesting | Evaluar y reforzar la seguridad de la página web y tienda online frente a vulnerabilidades técnicas | Sitio web corporativo y tienda online externalizada | Responsable de Seguridad / Proveedor externo | Herramientas de análisis (OWASP ZAP, Burp Suite), consultoría externa | 2 meses | 3000€ | Contrato con proveedor web actualizado |
| 09 | Monitorización SIEM | Mejorar la seguridad de acceso a sistemas críticos mediante políticas de contraseñas robustas y MFA | Equipos, servidores, servicios cloud y correo corporativo | Departamento TIC | Gestor de contraseñas, licencias MFA | 1 mes | 1800€ | Políticas de seguridad aprobadas |
| 10 | Gestión de contraseñas y MFA | Detectar incidentes y accesos no autorizados mediante el análisis centralizado de logs | Infraestructura de red, servidores y endpoints | Responsable de Seguridad / TIC | Plataforma SIEM o syslog centralizado, formación básica | 3 meses | 4000€ | Inventario de activos y roles definido |
...
|----------|---------|----------|---------------------------------|
| 0.1      | 5/11/2025 | Grupo 1 | Creación del documento borrador |
| 0.2      | 11/11/2025 | Grupo 1 | Primera revisión completa       |
| 1.0      |  | Grupo 1 | Versión final para aprobación   |
